...
\end{equation}
Es bleibt zu klären, welchen Wert die Elektonendichte für Aluminium $\rho_T$ in
...
\end{equation}
Hier ist $N_A$ die Avogadro-Konstante, deren Wert \cite{pdb} entnommen wurde,
und die anderen beiden Größen wurden \cite[Tab.2]{script} entnommen wurde. Die
Zahl der Elektronen pro Volumeneinheit lautet somit:
\begin{equation}
...
Hindernis aufgenommen wurde, so ergeben sich die folgenden Daten:
\begin{eqnarray}
N_0 &=& \\
\mu &=& \\
s &=& 
