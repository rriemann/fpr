...
\Omega_{\mathrm{Det}} = 
\end{equation}
Wenn man die in \cite[S.9]{script} nahegelegte Näherung trifft, dass
d$\sigma/$d$\Omega$ konstant ist, so kann man leicht den zugehörigen
Wirkungsquerschitt berechnen:
\begin{eqnarray}
\frac{d\sigma}{d\Omega} &=& \mathrm{const}=\frac{\sigma_{\mathrm{tot}}}{4\pi}\\
\sigma_{\mathrm{Det}} &=&\frac{\sigma_{\mathrm{tot}}}
{4\pi}\cdot\Omega_{\mathrm{Det}}
\end{eqnarray}
Hierbei ist $\sigma_{\mathrm{tot}}$ der im vorigen Abschnitt berechnete totale
