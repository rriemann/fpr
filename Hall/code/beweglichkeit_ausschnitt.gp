...
set output "../tmp/beweglichkeit_ausschnitt.pdf"
...
#set tmargin 0
#set rmargin 0.0
plot "../data/Daten_ausschnitt.DAT" using (log(abs(100*($1)))):(log(abs(0.3661327231121282*($3-$5)/2/(4*($2-$4)/55)))) with lp pt 7 ps 0.3 lc 0