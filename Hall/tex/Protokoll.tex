...
%   basicstyle=\ttfamily\scriptsize,
  morekeywords={TH1F,TLorentzVector,TVector3,vector,TFile,TFitResultPtr,TF1,TGraph,TH1,TObject,TCanvas,string,Double_t,TGraphErrors,TAxis,TStyle,TMath,TSpectrum,TPolyMarker,TString},
...
% 	colorlinks	=	true,
% 	urlcolor	=	darkblue,
	pdftitle	=	{Protokoll zum F-Praktikumsversuch 'Hall-Effekt'},
	pdfsubject	=	{Praktikumsversuch}
	pdfauthor	=   	{robert.riemann@physik.hu-berlin.de,thomas.murach@physik.hu-berlin.de},
	pdfkeywords	=	{Fortgeschrittenen-Praktikum,Praktikumsversuch, 2010, Hall-Effekt}
% 	pdfcreator	=	{pdftex},
% 	pdfproducer	=	{pdftex}
}
...
\vspace{14mm}
Hall-Effekt\\
\vspace{14mm} {\small{\textbf{Betreuer: Anna Aleksandrova}}}\\}
...
% \begin{tabular}{S[table-format = 2.1,table-figures-uncertainty = 1]}
%    20(2) \\
%    20.0(2)
% \end{tabular}
