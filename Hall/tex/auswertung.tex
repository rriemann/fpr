...
\subsection{Messung des Kristallstroms bei Raumtemperatur}
...
meisten Werte in einem kleinen Bereich um \SI{1}{\ohm}, andere hingegen in
einer ganz anderen Größenordnung von etwa 20 bis \SI{50}{\ohm}. Die Erklärung
dafür ist, dass in manchen Fällen ein unsauberer Kontakt zwischen unserer
Messspitze und dem Kontaktpunkt bestand, sodass in diesen Fällen nicht nur der
reale Widerstand innerhalb des Kristalls, sondern zusätzlich der viel größere
Kontaktwiderstand mit gemessen wurde. Man kann also annehmen, dass die internen
Widerstände in der Größenordnung von etwa \SI{1}{\ohm} liegen. Es muss aber
