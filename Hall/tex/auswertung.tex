...
% Bei steigender Temperatur, also im Bereich der Störstellenleitung,
% steigt zunächst der spezifische Widerstand, bis er einen Maximalwert erreicht.
% Bei noch weiter ansteigender Temperatur sinkt er dann monoton, bedingt durch die Eigenleitung.
...
\end{equation}
entspricht.
Da alle Größen bekannt sind, kann nun das Diagramm in \ref{hallkonstante}
...
Ladungsträgerkonzentration $n$, was man an der folgenden, dem \cite{ibach}
