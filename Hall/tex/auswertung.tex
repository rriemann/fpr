...
Aus der Tatsache, dass es sich um einen Vorzeichenwechsel handelt, kann man
gemäß \eref{hallkonst} schließen, dass es einen Übergang gibt, bei dem der eine
Ladungsträgertyp allmählich durch den anderen als dominanter Ladungsträger
abgelöst wird. In unserem Fall hat die Hallkonstante bei kleinen Temperaturen
ein 
