...
$T = \SI{77}{\kelvin}$ bestimmt werden. Hiefür gehen wir von \eref{hallkonst} aus
und erhalten:
\begin{equation}
 n = -\frac{1}{R_H e}
\end{equation}
Die Hallkonstante für die entsprechende Temperatur lässt sich der \fref{fig:hallkonstante2}
entnehmen. Bei Mittelung über beide Werte der Konstante erhält man:
\begin{equation*}
