...
\begin{figure}[htbp]
  \subfloat[Photomultiplier 1]{
    ...
    \includegraphics[width=0.245\textwidth,keepaspectratio]{../tmp/TEK00000.pdf}
  }
  
  \subfloat[Photomultiplier 2]{
    \label{fig:photomultiplier_2}
    \includegraphics[width=0.245\textwidth,keepaspectratio]{../tmp/TEK00001.pdf}
  }
  \\
  
  \subfloat[Photomultiplier 3]{
    \label{fig:photomultiplier_3}
    \includegraphics[width=0.245\textwidth,keepaspectratio]{../tmp/TEK00002.pdf}
  }
...
%   \newpage
  ...
  \subfloat[Photomultiplier 4]{
    ...
    \includegraphics[width=0.245\textwidth,keepaspectratio]{../tmp/TEK00003.pdf}
  }
  
  \subfloat[Photomultiplier 5]{
    \label{fig:photomultiplier_5}
    \includegraphics[width=0.245\textwidth,keepaspectratio]{../tmp/TEK00004.pdf}
  }
  \label{fig:PMs}
\end{figure}
