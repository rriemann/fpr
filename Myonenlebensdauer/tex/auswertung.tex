...
entnommen. Die Berechnung erfolgt mit \lref{Berechnungen}.
...
\begin{figure}[htb]
      ...
      \caption{Standbild des Digital-Oszilloskops zur Signalform-Betrachtung. \\
               schwarz: Vorverstärker, grün: Hauptverstärker}
...
Nun wurde im Histogramm jeder einzelnen Probe der Bereich des Maximums mit einer
...
Der Mittelwert der Gaußanpassung wurde nun den Energien der γ-Quanten zugeordnet.
Die Halbwertsbreite der Anpassung gibt den Fehler für den Mittelwert vor.
Aus dem entstehenden Diagramm in
...
ist zu untersuchen, ob zum einen die Lebensdauer des angeregten Kerns und zum
...
Die Gaußbreite $σ(E)$ ist aus \fref{ohne_hintergrund} bekannt. Der Fehler
...
wird noch einmal in \fref{rel_aufloesung_ideal} gezeigt, welches Ergebnis nach Abzug
...
\begin{figure}[htb]
      ...
      \label{fig:rel_aufloesung_ideal}
\end{figure}

In \fref{caesium_ohne_hintergrund_energie_ohne_hintergrund} haben wir das Cäsiumspektrum in
...
gefittet (siehe \fref{caesium_alu_ohne_hintergrund_energie}). Da man nun eine
...
Wir haben mit \fref{cs_sig_und_untergrund} auch einen gemeinsamen Fit für den
...
Allgemein sieht eine solche Gauß-Funktion folgerndermaßen aus:
\begin{equation}
...
Man kennt aus \cite[Gl.3]{script} den theoretischen Verlauf des Wirkungsquerschnitts
gemäß der Klein-Nishina-Formel. Um zu testen, wie weit unser berechnetes Ergebnis mit
der Vorhersage übereinstimmt, haben wir einen Plot \fref{klein_nishina} angefertigt,
in dem sowohl die Klein-Nishina-Formel als auch unser Punkt eingetragen ist.
\begin{figure}[htb]
      \centering
      \includegraphics[width=1\columnwidth,keepaspectratio]{../tmp/klein_nishina}
...
Außerdem ist nicht klar, inwieweit der Detektor selbst mit statistischen aber auch
