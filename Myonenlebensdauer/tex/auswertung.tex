...
\begin{figure}[ht!]
  ...
  \caption{Ausgangsdaten für die Eichung}
  \label{fig:eichung}
\end{figure}
...
\begin{figure}[ht!]
  ...
  \caption{Eichung mittels der Daten aus \fref{eichung} und der Batchfunktion \texttt{get\_calibration(TH1F*)} aus dem Quellcode in Anhang \ref{sec:sourcecode}}
