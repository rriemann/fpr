\documentclass[a4paper,twocolumn,oneside,bibtotoc,smallheadings,tocleft,pointlessnumbers,halfparskip,DIV15]{scrartcl}
...
% 	colorlinks	=	true,
% 	urlcolor	=	darkblue,
	pdftitle	=	{Protokoll zum F-Praktikumsversuch 'Quantenkryptographie'},
	pdfsubject	=	{Praktikumsversuch}
	pdfauthor	=   	{robert.riemann@physik.hu-berlin.de,thomas.murach@physik.hu-berlin.de},
	pdfkeywords	=	{Fortgeschrittenen-Praktikum,Praktikumsversuch, Quantenkryptographie, 2010},
	pdfcreator	=	{pdftex},
	pdfproducer	=	{pdftex}
}
...
\newcommand{\eref}[1]{Gl. (\ref{eqn:#1})} % refer to an equation, usage: \lref{label} for Tab. (...)
\newcommand{\sref}[1]{Kap. (\ref{sec:#1})} % refer to a section, usage: \sref{label} for Kap. (...)
