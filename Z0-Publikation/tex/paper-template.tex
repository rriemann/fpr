...
\fref{fit_hadrons}). By fitting the data
...
Firstly, the cross sections at the different center of mass energies could be calculated in an analogue way to the hadronic events. The results of this can be found in \tref{muon_events}.
...
points (see \fref{fit_muons}). This time the only free parameter is the muonic
cross section $σ_0^μ$.
